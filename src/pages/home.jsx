...
const stats = [
  {
    icon: <FaIndustry />,
    number: "18+",
    text: "Industrial Experiences",
  },
  {
    icon: <FaWarehouse />,
    number: "45,000+",
    text: "Factory Coverage (㎡)",
  },
  {
    icon: <FaTshirt />,
    number: "2,000,000+",
    text: "Annual Clothes Output",
  },
  {
    icon: <FaGlobe />,
    number: "100+",
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl px-6">
          ...
          <h1 className="text-white text-3xl md:text-5xl font-bold leading-tight">
            Custom Functional Clothing Manufacturer
          ...
          <p className="text-gray-200 mt-4 text-lg md:text-xl">
            Over 17 Years of OEM/ODM Service For High-Quality Functional Clothes
          </p>
      ...
      <section className="bg-gray-50 py-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <h2 className="text-center text-3xl md:text-4xl font-semibold text-indigo-700 mb-14">
            Strong OEM / ODM Functional Clothing Manufacturing Service
          </h2>
